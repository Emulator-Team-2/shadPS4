...
struct Liverpool {
    ...
    struct DepthBuffer {
        ...
        bool DepthReadValid() const {
            return DepthReadAddress() != 0 && z_info.format != ZFormat::Invalid;
        }
        ...
        bool StencilReadValid() const {
            return StencilReadAddress() != 0 && stencil_info.format != StencilFormat::Invalid;
        }
    ...
    union Regs {
        ...
        u32 NumSamples() const {
            ...
            if (depth_buffer.DepthWriteValid() || depth_buffer.StencilWriteValid()) {
